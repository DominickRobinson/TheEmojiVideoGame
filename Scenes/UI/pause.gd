...
@export var tags_visible_button : Button
...
func _ready():
	...
	#connect buttons
	tags_visible_button.toggled.connect(PlayerManager.set_tags_visible_mode)
	...
	tags_visible_button.button_pressed = PlayerManager.tags_visible_mode
